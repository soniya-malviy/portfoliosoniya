...
// import { ButtonsCard } from "./ui/tailwindcss-buttons.tsx";
...
export const LampContainer = ({
    ...
    return (
        ...
        >
            <div className="top-[-10px] relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                <motion.div
